  ...
  return (
    <CategoryPage
      ...
      tools={[
        ...
        { label: "Position Runs", description: "Detect a run before it ends.", to: "/draft#runs" },
        ...
        { label: "Spend Trends", description: "Pace of the room vs. expected curve.", to: "/draft#trends" },
      ]}
    />
  );
}
