  ...
  return (
    <CategoryPage
      ...
      tools={[
        ...
        { label: "Sleepers", description: "Late-round value picks priced under market.", to: "/draft#upnext" },
        { label: "Tier Targets", description: "Best remaining player in each tier.", to: "/draft#tiers" },
        { label: "Player Queue", description: "Your full research queue.", to: "/draft#upnext" },
      ]}
    />
  );
}
