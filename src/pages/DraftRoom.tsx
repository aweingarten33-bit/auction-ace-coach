                ...
                <>
                  ...
                  {top50InfoOpen && (
                    <div className="mb-4 space-y-2.5 rounded-xl border border-border/60 bg-secondary/20 px-3 py-3 text-xs leading-relaxed text-muted-foreground">
                      ...
                      <p>• <span className="font-semibold text-foreground">Proportional Optimization</span> — our league's auction spend across the last 3 drafts is distributed proportionately across player tiers, then broken down to individual players within each tier by their ESPN ranking.</p>
