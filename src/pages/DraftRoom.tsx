                ...
                <>
                  ...
                  {top50InfoOpen && (
                    <div className="mb-4 space-y-2.5 rounded-xl border border-border/60 bg-secondary/20 px-3 py-3 text-xs leading-relaxed text-muted-foreground">
                      ...
                      <p>• <span className="font-semibold text-foreground">VORP (Value Over Replacement Player)</span> — projected points above the worst starter at their position. Dollar value is their share of the total VORP pool, adjusted using our league's last 3 drafts.</p>
