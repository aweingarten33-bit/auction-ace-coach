                ...
                <>
                  ...
                  {top50InfoOpen && (
                    <div className="mb-4 space-y-2.5 rounded-xl border border-border/60 bg-secondary/20 px-3 py-3 text-xs leading-relaxed text-muted-foreground">
                      ...
                      <p>• <span className="font-semibold text-foreground">VORP (Value Over Replacement Player)</span> — each player's projected $ value is based on how many more fantasy points they're projected to score (per ESPN) than the best available waiver wire player at their position, calibrated against our league's last 3 auction drafts.</p>
