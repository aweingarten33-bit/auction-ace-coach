                ...
                <>
                  ...
                  {top50InfoOpen && (
                    <div className="mb-4 space-y-2.5 rounded-xl border border-border/60 bg-secondary/20 px-3 py-3 text-xs leading-relaxed text-muted-foreground">
                      ...
                      <p>• <span className="font-semibold text-foreground">Proportional Optimization</span> — 3 years of your league's actual auction spending is used to distribute projected dollar value across player tiers (elite, mid-range, depth), then down to each individual player within those tiers. That two-step process is what produces the projected value next to every name.</p>
