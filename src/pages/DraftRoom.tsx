                ...
                <>
                  ...
                  {top50InfoOpen && (
                    <div className="mb-4 space-y-2.5 rounded-xl border border-border/60 bg-secondary/20 px-3 py-3 text-xs leading-relaxed text-muted-foreground">
                      ...
                      <p>• <span className="font-semibold text-foreground">Proportional Optimization</span> — the prices paid across your league's previous 3 auction drafts are used to determine how value gets distributed across player tiers and then to individual players. The total available auction dollars are divided proportionally — elite players claim the largest share, mid-tier players get the middle, and the rest gets distributed down from there based on each player's share of total surplus value.</p>
