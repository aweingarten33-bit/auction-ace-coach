                ...
                <>
                  ...
                  {top50InfoOpen && (
                    <div className="mb-4 space-y-2.5 rounded-xl border border-border/60 bg-secondary/20 px-3 py-3 text-xs leading-relaxed text-muted-foreground">
                      ...
                      <p>• <span className="font-semibold text-foreground">Proportional Optimization</span> — using applied mathematics, the actual dollar amounts spent on players across your league's last 3 auction drafts are analyzed to proportionally assign projected values to players this season. Value is first distributed across tiers of players, then allocated to each individual — so every projected price you see is derived directly from your league's own spending history.</p>
