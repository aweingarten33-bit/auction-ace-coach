...
export default function DraftRoom() {
  ...
  return (
    <div className="flex h-screen flex-col overflow-hidden bg-background text-foreground">
      ...
      {/* ── MAIN PLAN VIEW ──────────────────────────────────── */}
      <div className="relative min-h-0 flex-1 overflow-y-auto px-3 pb-24 pt-3">
                ...
                <>
                  ...
                  {top50InfoOpen && (
                    <div className="mb-4 space-y-2.5 rounded-xl border border-border/60 bg-secondary/20 px-3 py-3 text-xs leading-relaxed text-muted-foreground">
                      ...
                      <p>• <span className="font-semibold text-foreground">Proportional Optimization</span> — using applied mathematics, the actual dollar amounts spent on players across your league's last 3 auction drafts are analyzed to proportionally assign projected values for this season. First, the total available auction budget gets distributed across player tiers — elite players at the top, mid-range in the middle, depth at the bottom. Then within each tier, that value gets broken down further to each individual player based on how they rank within that group. The projected dollar value you see next to every player is the result of that two-step process.</p>
