                ...
                <>
                  ...
                  {top50InfoOpen && (
                    <div className="mb-4 space-y-2.5 rounded-xl border border-border/60 bg-secondary/20 px-3 py-3 text-xs leading-relaxed text-muted-foreground">
                      ...
                      <p>• <span className="font-semibold text-foreground">Proportional Optimization</span> — think trickle-down economics, except this version actually works. The total auction money in the room flows from the top down: elite players absorb the largest share first, mid-tier players get what's proportionally left, and value continues distributing down through every tier. Each player's cut is determined by how far above replacement level they sit — the bigger that gap, the bigger their slice. Your league's 3 years of actual prices paid is what calibrates where each tier starts and ends.</p>
