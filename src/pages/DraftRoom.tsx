                ...
                <>
                  ...
                  {top50InfoOpen && (
                    <div className="mb-4 space-y-2.5 rounded-xl border border-border/60 bg-secondary/20 px-3 py-3 text-xs leading-relaxed text-muted-foreground">
                      ...
                      <p>• <span className="font-semibold text-foreground">Proportional Optimization</span> — each player's projected dollar value starts from what was actually paid in your league's last 3 auction drafts. That total pool of auction money gets allocated across player tiers first, then within each tier it's broken down further to individual players based on their ESPN rankings. The result is a price grounded in your league's real spending history and where each player stands within their position group.</p>
